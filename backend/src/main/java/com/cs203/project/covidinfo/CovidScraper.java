...
public class CovidScraper {
	...
	public void test() {
		...
		try {
			...
			String averageAge = document.getElementsByClass("tx-20 tx-sm-18 tx-md-24 tx-normal tx-rubik mg-b-0").first()
					.text();
			...
			for (Element e : nationalityElements) {
				...
				// String percentage = e.getElementsByClass("wd-60 tx-right tx-rubik mg-l-5
				// tx-success").get(0).text();
			...
			Element table = document.getElementsByClass("table table-borderless table-dashboard table-dashboard-one")
					.first();
...
// final HtmlPage page =
// webClient.getPage("https://www.moh.gov.sg/covid-19-phase-advisory/phase-3-sector-related-advisories");
// List<HtmlAnchor> anchors = page.getAnchors();;
// HtmlAnchor regulationsAnchor = null;
// for (HtmlAnchor anchor: anchors) {
// if (anchor.getTextContent().contains("Updated Advisory for Safe Management
// Measures at Food & Beverage Establishments")) {
...
//// return extractText("https://www.enterprisesg.gov.sg/" +
// anchor.attr("href"));
// return "YAY";
// } catch (Exception e) {
// return e.getMessage();
...
// URL url = new
// URL("https://www.enterprisesg.gov.sg//-/media/esg/files/media-centre/media-releases/2021/august/mr05921_updated-advisory-for-safe-management-measures-at-food-beverage-establishments.pdf?la=en");
