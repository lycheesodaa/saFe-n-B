...
public class TimeslotServiceImpl implements TimeslotService {
    ...
    public List<Timeslot> getByEmployeeId(String email) {
        return timeslots.findByEmployeeEmail(email);
    }

    @Override
    public Timeslot getByIdAndEmployeeId(Long id, String email) {
        return timeslots.findByIdAndEmployeeEmail(id, email).orElse(null);
    }
    ...
    public Timeslot getByEmployeeIdAndDate(String email, LocalDate date) {
        return timeslots.findByEmployeeEmailAndDate(email, date).orElse(null);
    }
